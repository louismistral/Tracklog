...
| **Atelier** (`#atelier`) | La page qui rend tout le vocabulaire côte à côte : les jetons, les **déclinaisons** (l'axe des apparitions), les composants en familles Atomic Design (atomes · molécules · organismes · modales · pages · technique), et l'audit des classes. Tout s'y présente en **vignettes** : fermée, une carte ne montre que la chose, son nom et son nombre de déclinaisons ; ouverte, elle donne la description, toutes les variantes et où elles vivent. Le nom d'une variante — sa prop, sa classe, son état — est dans le **survol**, jamais en ligne. Une **adresse**, pas un onglet : ni compte ni données. Sert à voir ce qu'un changement de thème déplace, et à regarder ce qui existe avant d'inventer un contrôle de plus. `#sink`, son ancienne adresse, y mène toujours. |
